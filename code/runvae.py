...
if __name__ == "__main__":
    ...
    configs = [
        ["mnist", "cnn", True, 4, 1024, "made", False, 6, 0],
        ["mnist", "cnn", True, 4, 1024, "made", False, 6, -0.125],
        ["mnist", "cnn", True, 2, 1024, "cnn", False, 6, 0],
        ["mnist", "cnn", True, 2, 1024, "cnn", False, 6, -0.125]
    ]
